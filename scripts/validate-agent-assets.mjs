...
const semanticRequirements = {
  "qa-orchestrator": [
    ...
    "Resumo Do Fluxo",
    "reutilizar a URL ja localizada",
  ],
  "qa-bdd-specialist": [
    "SPEC",
    "Cenarios BDD",
    ...
    "Criterios De Aceite Redundantes",
    "Conflitos Entre Evidencias",
    "Requisitos Implicitos Identificados",
    "Premissas Necessarias",
    "nunca cria requisito",
  ],
  "qa-wiki-specialist": [
    "Wiki",
    "SPEC",
    ...
    "Possiveis Paginas Orfas",
    "Possiveis Paginas Duplicadas",
    "Padronizacao Entre Paginas",
    "Organizacao Da Wiki",
    "Padroes Encontrados",
    "nunca durante publicacao ou sincronizacao",
  ],
  "qa-bug-specialist": [
    "Tipo Do Defeito",
    "Profile ativo",
    ...
    "Bugs Semelhantes",
    "Nenhum Bug semelhante encontrado",
    "Validacoes Recomendadas",
    "Confiabilidade Da Analise",
    "nunca formato Gherkin",
    "varredura ampla",
    "Acoes Pos-Criacao",
  ],
  "qa-health-specialist": [
